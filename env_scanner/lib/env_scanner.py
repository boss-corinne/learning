...
def main():
    ...
    list_envs.add_argument("-p", "--package", dest="package", required=False,
                           help="Only list environments containing the "
                                "specified package")
    list_envs.add_argument("-v", "--version", required=False,
                           help="Only list environments containing the "
                                "matching version of specified package (must "
                                "be used in conjunction with '--package'")
    list_envs.add_argument("-i", "--immutables", default=False, required=False,
                           action="store_true",
